...
export default function Dashboard() {
  ...
  // 🔥 NEW STATES: For dynamic assessments and the instructions modal
  ...
  useEffect(() => {
    ...
    // 🔥 NEW FUNCTION: Fetch the 3 seeded assessments from the database
  ...
  // 🔥 UPDATED: Sends the specific assessment ID to the backend
  const handleStart = async () => {
    setIsStarting(true);
    try {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-6 pt-24 pb-12">
        ...
        <div className="mt-4">
          {activeTab === "assessments" && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* 🔥 UPDATED: Dynamically map through the 3 assessments from the database */}
        ...
        {/* 🔥 NEW: Render the Instructions Modal */}
        <InstructionsModal 
